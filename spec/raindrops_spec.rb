...
describe Raindrops do
  ...
  describe '#converter' do
    ...
    it "prints 'PlingPlang' for numbers with a factor of 3 and 5" do
      expect { raindrops.converter(30) }.to output('PlingPlang').to_stdout
    end

    it "prints 'Plong' for numbers with a factor of 7" do
      expect { raindrops.converter(28) }.to output('Plong').to_stdout
    end
    ...
    it "prints the number as a string if it doesn't have a factor of 3,
                                                                5 or 7" do
